...
// User DAOs are the services that use User DTOs
var UsersDao = /** @class */ (function () {
    function UsersDao() {
        this.users = [];
        log("Created new instance of UsersDao");
    }
    UsersDao.getInstance = function () {
    ...
    UsersDao.prototype.putUserById = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var objIndex;
            return __generator(this, function (_a) {
                objIndex = this.users.findIndex(function (obj) { return obj.id === user.id; });
                this.users.splice(objIndex, 1, user);
                return [2 /*return*/, user.id + " updated via put"];
            });
        });
    };
    UsersDao.prototype.patchUserById = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, user.id + " patched"];
            });
        });
    };
    UsersDao.prototype.removeUserById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, userId + " removed"];
            });
        });
    };
